...
SOURCE_ROOTS = [
    ...
    SAT_SIM_ROOT / "outputs" / "c7_candidate_figures",
    SAT_SIM_ROOT / "outputs" / "c7_manuscript_figure_recreation",
...
def _group_for(path: Path) -> str:
    ...
    if "outputs/step3_low_cost_exploration" in text:
        return "Step 3 low-cost exploration"
    if "outputs/step3_micro_benchmarks" in text:
    ...
    if "outputs/step3_residual_cov_failure_audit" in text:
    ...
    if "outputs/c7_candidate_figures" in text:
        return "C7 candidate figure validation"
    if "outputs/c7_manuscript_figure_recreation" in text:
        return "C7 manuscript figure recreation"
