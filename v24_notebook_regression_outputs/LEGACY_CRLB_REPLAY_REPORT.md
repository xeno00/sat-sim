...
- Output root: `v24_notebook_regression_outputs\executed_legacy\crlb_replay`
- Manuscript ready: `False`
- Full notebook executed: `False`

## Replayed Figures

- `pos_crlb_0dB_0dB.pdf` -> `v24_notebook_regression_outputs\executed_legacy\crlb_replay\pos_crlb_0dB_0dB.pdf`; status `legacy_replayed_unverified_match`
- `sync_crlb_0dB_0dB.pdf` -> `v24_notebook_regression_outputs\executed_legacy\crlb_replay\sync_crlb_0dB_0dB.pdf`; status `legacy_replayed_unverified_match`
...
- Comparison status: `unverified_match`
- Claim match: `False`
