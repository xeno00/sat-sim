...
- Mode: `smoke`
- Output root: `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay`
- Manuscript ready: `False`

## Outputs

- `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\legacy_clock_sweep_raw.csv`
- `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\legacy_clock_sweep_summary.csv`
- `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\legacy_clock_sweep_arrays.npz`
- `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\pos_vary_clock.pdf`
- `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\sync_vary_clock.pdf`
...
- `total_fallback_events`: 6
- `il_failures`: 0
- `lm_failures`: 0
- `map_failures`: 0
- `map_global_fallback_count`: 6
