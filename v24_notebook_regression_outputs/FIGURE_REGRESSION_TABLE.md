...
| pos_vary_clock.pdf | legacy_replayed_unverified_match | True | False | Legacy notebook clock-sweep logic replayed in redirected diagnostics; match is unverified and legacy caveats remain. |
| sync_vary_clock.pdf | legacy_replayed_unverified_match | True | False | Legacy notebook clock-sweep logic replayed in redirected diagnostics; match is unverified and legacy caveats remain. |
...
- Clock-sweep replay report: `v24_notebook_regression_outputs\executed_legacy\clock_sweep_replay\legacy_clock_sweep_metadata.json`
