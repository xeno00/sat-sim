...
| package_native_c7_normalized_card_v1 | package_native_current | A1_package_dl_only | B1_residual_lm | C7_residual_cov_sync_safeguard | no truth-state acceptance; truth only for offline metrics | units_consistent | human_review_only | std_nu3_ns10_fullmesh_los_clock1us_seed0 | missing | 1105.154546 | 4289.809278 | 4287.922982 | missing | 937.214321 | 3882.060953 | 3879.785515 | yes | no | First normalized benchmark-card run. C7 slightly improves over Step B, but Step B/C are much worse than Step A and legacy-like primary cards. |
...
Add safe executable adapters for `controlled_migration_step_b_lm_only` and `legacy_surgical_prior_region`, then rerun the same normalized `std_nu3_ns10_fullmesh_los_clock1us_seed0` benchmark-card command. The first runner now executes `package_native_c7` and writes explicit missing cards for unavailable adapters.
